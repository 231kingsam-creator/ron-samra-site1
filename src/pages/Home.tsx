  ...
  return (
    <section id="pricing" className="py-20">
      <div className="mx-auto max-w-5xl px-6">
        <div className="mb-12 text-center">
          <span className="text-xs font-bold uppercase tracking-widest text-amber-600">מחירים</span>
          <h2 className="mt-2 text-3xl font-bold text-foreground md:text-4xl">שקוף ופשוט</h2>
          <p className="mt-3 text-muted-foreground">ביטול חינם עד 24 שעות מראש</p>
        </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-border bg-card p-6 flex flex-col">
            <span className="text-xs font-bold uppercase tracking-wider text-amber-600 mb-3">טיפול ראשון</span>
            <div className="flex items-end gap-1 mb-1">
              <span className="font-['Frank_Ruhl_Libre'] text-4xl font-bold text-foreground">₪525</span>
            </div>
            <p className="text-xs text-muted-foreground mb-4">60–75 דקות</p>
            <ul className="space-y-2 text-sm text-stone-600 flex-1">
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>אבחון מלא</li>
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>תשאול רפואי</li>
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>תוכנית טיפול אישית</li>
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>טיפול דיקור ראשון</li>
            </ul>
          </div>

          {/* Follow-up */}
          <div className="rounded-2xl border border-border bg-card p-6 flex flex-col">
            <span className="text-xs font-bold uppercase tracking-wider text-amber-600 mb-3">טיפול המשך</span>
            <div className="flex items-end gap-1 mb-1">
              <span className="font-['Frank_Ruhl_Libre'] text-4xl font-bold text-foreground">₪450</span>
            </div>
            <p className="text-xs text-muted-foreground mb-4">45–60 דקות</p>
            <ul className="space-y-2 text-sm text-stone-600 flex-1">
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>דיקור מותאם אישית</li>
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>שמירה על התוצאות</li>
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>עדכון תוכנית הטיפול</li>
            </ul>
          </div>

          {/* Package 5 */}
          <div className="rounded-2xl border border-border bg-card p-6 flex flex-col">
            <span className="text-xs font-bold uppercase tracking-wider text-amber-600 mb-3">חבילת 5 טיפולים</span>
            <div className="flex items-end gap-1 mb-1">
              <span className="font-['Frank_Ruhl_Libre'] text-4xl font-bold text-foreground">₪2,000</span>
            </div>
            <p className="text-xs text-green-600 font-semibold mb-4">חיסכון של ₪250</p>
            <ul className="space-y-2 text-sm text-stone-600 flex-1">
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>לבעיות חדשות ואקוטיות</li>
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>3–5 שבועות טיפול</li>
            </ul>
          </div>

          {/* Package 10 — highlighted */}
          <div className="rounded-2xl border-2 border-amber-400 bg-amber-50/50 p-6 flex flex-col relative">
            <div className="absolute -top-3 start-1/2 -translate-x-1/2 rtl:translate-x-1/2">
              <span className="rounded-full bg-amber-500 px-3 py-0.5 text-xs font-bold text-white whitespace-nowrap">פופולרי ביותר</span>
            </div>
            <span className="text-xs font-bold uppercase tracking-wider text-amber-600 mb-3">חבילת 10 טיפולים</span>
            <div className="flex items-end gap-1 mb-1">
              <span className="font-['Frank_Ruhl_Libre'] text-4xl font-bold text-foreground">₪3,800</span>
            </div>
            <p className="text-xs text-green-600 font-semibold mb-4">חיסכון של ₪700</p>
            <ul className="space-y-2 text-sm text-stone-600 flex-1">
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>לבעיות כרוניות</li>
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>6–10 שבועות טיפול</li>
              <li className="flex gap-2"><span className="text-amber-500 shrink-0">✓</span>המחיר הטוב ביותר</li>
            </ul>
          </div>
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          ניתן לשלם במזומן, העברה בנקאית, ביט או פייבוקס
        </p>
      </div>
    </section>
  )
