        ...
        <div className="grid gap-12 md:grid-cols-[1fr_1.6fr] md:items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <div className="space-y-3 text-stone-600 leading-relaxed text-sm md:text-base">
              <p>
                כילד הסתכלתי על אבי כשחזר הביתה מדי ערב — רופא בכיר ומנהל מחלקה פנימית בבית חולים תל השומר.
                למרות העייפות, היה על פניו אור של מי שהצליח לעזור להרבה אנשים. זה ריגש אותי עמוקות.
              </p>
              <p>
                לאחר תואר ראשון בביולוגיה באוניברסיטה העברית, טסתי לאנגליה וסיימתי לימודים
                בקולג' הבינלאומי לרפואה סינית (I.C.O.M) — המוביל בלימודי אקופונקטורה באירופה.
                שם נחשפתי לעולם חדש: רפואה המבוססת על היחסים ההרמוניים בין האדם ליקום,
                ועל החיבור בין גוף ונפש.
              </p>
              <p>
                מזה 35+ שנים אני מטפל במסגרת ציבורית ופרטית — כולל מחלקת הרפואה המשלימה
                של כללית, והוראה בתכנית לרפואה סינית עתיקה באוניברסיטה העברית.
                בעבודתי אני משלב דיקור סיני, טווינה, מוקסה, כוסות רוח וייעוץ תזונתי.
              </p>
              <p>
                בשנים האחרונות אני מלווה אנשים רבים המחפשים דרך אחרת להתמודד עם לחץ,
                מתח נפשי, וקשיים פיזיים ורגשיים — מבלי להיזקק לתרופות עם תופעות לוואי.
              </p>
            </div>
